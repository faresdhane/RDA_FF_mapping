...
RDA_Mapping_R_Graphs_circles: to cross-match the groups and the topics and to produce a graph to explore the cross-matching

Finally, run 'RDA_Mapping_R_Bar_plots'.
RDA_Mapping_R_Bar_plots: to produce a barplot of the number of groups per group of funders forum topics.
